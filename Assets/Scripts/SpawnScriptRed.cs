...
using UnityEngine;
using Vuforia;
public class SpawnScriptRed : MonoBehaviour
{
    ...
    {
        GameObject virus = Instantiate(mVirusObj, (Random.insideUnitSphere * 10) + transform.position, transform.rotation) as GameObject;
